...
const FruitVe = (props) => {
    ...
    const getAllProduct = async () => {
        try {
            const response = await fetch(`${BASE2_URL}/product/findProducts?key=${props.productCategoryNew}`, {
                headers: {
            ...
            <div className="flex flex-col items-center">
                <div className="flex flex-col mt-[2rem] mb-[1.5rem]   w-[90%]">
                    ...
                    <nav className="flex text-[1.2rem] gap-2">
                        <li className="list-none hover:text-[#329967]"><a href="/">Home</a></li>
...
FruitVe.propTypes = {
    productCategoryNew: PropTypes.string.isRequired
}
